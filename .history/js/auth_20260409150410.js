...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function toast(msg, type, duration) {
    if (typeof showToast === "function") {
      ...
      // Fallback minimal toast (in case script.js hasn't run)
      var t = document.createElement("div");
      t.style.cssText = [
        "position:fixed;bottom:90px;right:24px;",
        "background:", type === "success" ? "#28a745" : type === "error" ? "#e74c3c" : "#FF5722", ";",
        ...
        "animation:htSlideIn .35s ease;max-width:300px;"
      ].join("");
      t.textContent = msg;
      document.body.appendChild(t);
      setTimeout(function () { t.remove(); }, duration || 3200);
    }
  }
